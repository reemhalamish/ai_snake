...
class LaserTracker(object):
    ...
    def display(self, img, frame):
        ...
        key = cv2.waitKey(TIME_BETWEEN_FRAMES_MS)
        global topLeft, topRight, botLeft, botRight
        if key == ord('1'):
            topLeft = self.ave_x, self.ave_y
        elif key == ord('2'):
            topRight = self.ave_x, self.ave_y
        elif key == ord('3'):
            botLeft = self.ave_x, self.ave_y
        elif key == ord('4'):
            botRight = self.ave_x, self.ave_y
        elif key == ord('q') or all_corners_exist():
    ...
    def setup_windows(self):
        ...
        #self.create_fullscreen_window('LaserPointer')
    ...
    def run(self):
        ...
        while True:
            ...
            updated = self.detect_laser(hsv_image)
    ...
    def detect_laser(self, img):
        ...
        print("shape: ", cpy.shape, "width:", width, "corners:", display_corners())
...
def all_corners_exist():
    if topLeft and topRight and botLeft and botRight:
...
def display_corners():
    print("topLeft:", topLeft, "topRight:", topRight, "botLeft:", botLeft, "botRight:", botRight)
